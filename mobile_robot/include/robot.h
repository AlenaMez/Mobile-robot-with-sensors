...
public:
    ...
    double r_;
    // base distance, that is between the wheels
    double b_;
    // if the wheel were initialized or not
    bool wheelsInit_ = false;
    // wheel angular velocity limit
    double omegaLimit_;

    // initialize the radius, base distance and angular velocity limit
    void initWheel (double _r, double _b, double _omegaLimit);
